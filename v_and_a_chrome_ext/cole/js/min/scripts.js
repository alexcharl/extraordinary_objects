...
(function (window, $, Modernizr) {
  ...
  function setupKeyboardShortcuts() {
    ...
    document.addEventListener('click', function (event) {
      ...
      if (event.target.closest('.object-image-wrapper') && !event.target.closest('.share-icons') && !event.target.closest('a') && !event.target.closest('button')) {
...
(function (window, $) {
  ...
  class VandAApi extends MuseumApi {
    constructor() {
      ...
      this.defaultSearchTerms = ["Architecture", "Asia", "British Galleries", "Ceramics", "Childhood", "Contemporary", "Fashion", "Jewellery", "Furniture", "Glass", "Metalwork", "Paintings", "Drawings", "Photography", "Prints", "Books", "Sculpture", "Textiles", "Theatre", "Medieval", "Renaissance", "Baroque", "Rococo", "Neoclassical", "Victorian", "Art Nouveau", "Art Deco", "Modernism", "Postmodern", "Islamic", "Chinese", "Japanese", "Indian", "African", "American", "European", "Ancient", "Classical", "Gothic", "Romanesque", "Byzantine", "Ottoman", "Mughal", "Persian", "Egyptian", "Greek", "Roman", "Celtic", "Viking", "Prehistoric", "Bronze Age", "Iron Age", "Early Modern", "Industrial Revolution"];
...
class ErrorHandler {
  ...
  setupPromiseRejectionHandler() {
    window.addEventListener('unhandledrejection', event => {
      ...
      this.handleError({
        type: 'promise',
        error: event.reason,
        message: ((_event$reason2 = event.reason) === null || _event$reason2 === void 0 ? void 0 : _event$reason2.message) || 'Unhandled promise rejection'
      });
    });
  }
  ...
  handleError(errorInfo) {
    ...
    const errorObject = {
      ...
      type,
      message: message || (error === null || error === void 0 ? void 0 : error.message) || 'An unknown error occurred',
      error,
      context,
      retryable,
      severity,
  ...
  isRetryableAPIError(errorObject) {
    var _errorObject$context;
    const retryableStatusCodes = [408, 429, 500, 502, 503, 504];
    const retryableMessages = ['timeout', 'network', 'connection', 'server', 'temporary'];

    // Check status code if available
    if ((_errorObject$context = errorObject.context) !== null && _errorObject$context !== void 0 && _errorObject$context.statusCode) {
  ...
  async retryOperation(errorObject) {
    var _errorObject$context2;
    const operationId = ((_errorObject$context2 = errorObject.context) === null || _errorObject$context2 === void 0 ? void 0 : _errorObject$context2.operationId) || errorObject.id;
    ...
    // Attempt retry
    try {
      var _errorObject$context3;
      if ((_errorObject$context3 = errorObject.context) !== null && _errorObject$context3 !== void 0 && _errorObject$context3.retryFunction) {
  ...
  reinitializeComponent(errorObject) {
    var _errorObject$context4;
    const componentName = (_errorObject$context4 = errorObject.context) === null || _errorObject$context4 === void 0 ? void 0 : _errorObject$context4.componentName;
